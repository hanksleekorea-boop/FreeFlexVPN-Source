...
modules = ("client_keygen.js", "pwa_api_client.js", "moment_catalog.js", "platform_support.js", "pwa_runtime.js")
check("G17 PWA API 모듈 5종과 단일 파일 HTML 진입점", all((PUBLIC / name).is_file() for name in modules) and 'data-freeflex-runtime="inline"' in app_body and 'src="./pwa_runtime.js"' not in app_body)
