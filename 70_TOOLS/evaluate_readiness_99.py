...
def main() -> int:
    ...
    try:
        result = verify_and_evaluate_readiness_99(mobile_receipt=args.mobile, pc_receipt=args.pc, operations_bundle=args.operations, development_bundle=args.development, project_root=ROOT)
